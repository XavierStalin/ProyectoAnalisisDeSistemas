...
\begin{figure}[H]
    \centering
    \placeholderfig[5.5cm]{Representación visual de la fachada física del local de la tienda de comida de mascotas PetShop Huellitas \& Snacks}
...
\subsubsection{Pasos para definir la estrategia usando el análisis FODA}
De acuerdo a las buenas prácticas de planificación estratégica y diseño de sistemas, el proceso se estructura bajo los siguientes pasos:
\begin{enumerate}
    \item \textbf{Establecer las fortalezas, oportunidades, debilidades y amenazas:} Se identifican y catalogan los factores críticos internos y externos del entorno comercial (Matriz FODA descrita en el punto anterior).
    \item \textbf{Obtener las estrategias FO (Maxi-Maxi):} Se combinan las fortalezas con las oportunidades para potenciar el crecimiento y expansión de la tienda.
    \item \textbf{Cruce y combinaciones FO:} En este cruce se busca determinar cómo las capacidades internas de la empresa pueden maximizar las ventajas competitivas. Se puede combinar una fortaleza con una oportunidad, una con varias, o múltiples fortalezas con múltiples oportunidades.
    \item \textbf{Obtener las estrategias DO (Mini-Maxi):} Resultan de combinar las debilidades de la empresa con las oportunidades externas para superar debilidades operativas mediante la adopción de nuevas oportunidades.
    \item \textbf{Obtener las estrategias FA (Maxi-Mini):} Surgen al cruzar las fortalezas internas con las amenazas externas del mercado para blindar el negocio ante riesgos.
    \item \textbf{Obtener las estrategias DA (Mini-Mini):} Resultan de combinar las debilidades internas con las amenazas externas para reducir la vulnerabilidad del negocio y evitar riesgos directos.
    \item \textbf{Selección y priorización de estrategias:} Se procede a priorizar el listado de estrategias obtenido, evaluándolas bajo la siguiente escala de viabilidad:
    \begin{itemize}[label=\textbullet]
        \item No se debe poner en práctica.
        \item Se podría poner en práctica.
        \item Se debería poner en práctica.
        \item \textbf{Se debe poner en práctica} (Escala correspondiente a la Estrategia DA / MIN-MIN de supervivencia seleccionada para este desarrollo).
    \end{itemize}
\end{enumerate}

\subsubsection{Matriz de Cruce de Estrategias}
A continuación se presenta la matriz de cruce de estrategias donde se detallan las combinaciones FO, DO, FA y DA para el caso de estudio de PetShop Huellitas \& Snacks:

\begin{table}[H]
    \centering
    \small
    \renewcommand{\arraystretch}{1.5}
    \begin{tabularx}{\textwidth}{|>{\bfseries\raggedright\arraybackslash}p{3cm}|L|L|}
        \hline
        \rowcolor{upsblue}
        \textcolor{white}{\textbf{}} & \textcolor{white}{\textbf{Fortalezas}} & \textcolor{white}{\textbf{Debilidades}} \\
        \hline
        \textbf{Oportunidades} & 
        \textbf{Estrategias FO} \par
        Utilizar fortalezas para aprovechar las oportunidades: \par
        \textit{Desarrollar un canal e-commerce de pedidos automáticos aprovechando la variedad de marcas premium y el servicio de entrega express propio.} & 
        \textbf{Estrategias DO} \par
        Superar debilidades al aprovechar oportunidades: \par
        \textit{Implementar un sistema web transaccional integrado para capturar la demanda de pedidos y reducir la toma manual telefónica.} \\
        \hline
        \textbf{Amenazas} & 
        \textbf{Estrategias FA} \par
        Utilizar fortalezas para evitar amenazas: \par
        \textit{Fidelizar clientes mediante marcas de comida premium exclusivas para contrarrestar la competencia de supermercados de bajo costo.} & 
        \textbf{Estrategias DA (MIN-MIN)} \par
        \textbf{Seleccionada para el sistema} \par
        Reducir debilidades y evitar amenazas: \par
        \textit{Sistematizar y automatizar el inventario físico en tiempo real y emitir alertas automáticas al proveedor, reduciendo costos operativos y previniendo quiebres de stock por demoras del importador.} \\
        \hline
    \end{tabularx}
    \caption{Matriz de Estrategias y Cruce FODA}
    \label{tab:cruce_estrategias}
\end{table}
